pipeline {
  ...
  stages {
    ...
    stage('Release') {
      ...
      //}
      steps{
        sh 'docker build -t 492681564023.dkr.ecr.us-east-1.amazonaws.com/backend:${TAG_NAME} .'
        ...
        sh 'docker push 492681564023.dkr.ecr.us-east-1.amazonaws.com/backend:${TAG_NAME}'
      }
    }
